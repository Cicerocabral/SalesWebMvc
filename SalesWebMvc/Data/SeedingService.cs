    ...
    public class SeedingService
    {
       ...
       public SeedingService(SalesWebMvcContext context)
       {
        ...
        public void Seed()
        {
            ...
            _context.Department.AddRange(d1, d2, d3, d4); //Inserindo os departamentos

            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6); //Inserindo os vendedores

            _context.SalesRecord.AddRange( //Inserindo vendas para os vendedores
